package com.robertgeek.versioning;
...
public class PersonVersioningController {
	...
	@GetMapping(path = "/person/produces", produces = "application/vnd.robertgeek.app-v1+json")
	public PersonV1 producesV1() {
		return new PersonV1("Bob Charlie");
	}

	@GetMapping(path = "/person/produces", produces = "application/vnd.robertgeek.app-v2+json")
